...
public class CreateAdmin {
    ...
    public void createAdmin() {
        if (entityManager.find(User.class, (long)1) == null) {
            entityManager.createNativeQuery("INSERT INTO users (id, name, password, email) values (1, 'admin', '$2y$10$SL2.FVkvG2PQcbPTY8BOrebt7Ukgf2p0nw53gYl9UmHa1FxS24i0m', 'admin@mail.ru')").executeUpdate();
